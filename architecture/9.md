...
## 1
Resourcesareavailableathttps://github.com/Tongji-KGLLM/
RAG-Survey
...
## 6
## TABLE I
## SUMMARY OFRAGMETHODS
MethodRetrieval Source
## Retrieval
## Data Type
## Retrieval
## Granularity
...
versions including HotpotQA
## 4
(1st October , 2017), DPR
## 5
## (20
...
discern  whether  “LLM”  refers  tolarge  language  modelor  a
Master of Lawsin a legal context.
...
Semantic  Routeris  another  method  of  routing  involves
leveraging  the  semantic  information  of  the  query.  Specific
apprach  see  Semantic  Router
## 6
.  Certainly,  a  hybrid  routing
...
instruct tuning. Hugging Face’s MTEB leaderboard
## 7
evaluates
...
## 13
## TABLE II
## DOWNSTREAM  TASKS AND DATASETS OFRAG
TaskSub TaskDatasetMethod
QASingle-hopNatural Qustion(NQ) [111]
...
## 14
## TABLE III
## SUMMARY OF METRICS APPLICABLE FOR EVALUATION ASPECTS OFRAG
## Context
## Relevance
## Faithfulness
## Answer
...
ARES  [165],  and  TruLens
## 8
employ  LLMs  to  adjudicate  the
...
## VII.  DISCUSSION ANDFUTUREPROSPECTS
...
effortlessly manage contexts exceeding 200,000 tokens
## 9
## . This
...
## 8
https://www.trulens.org/trulens
eval/coreconceptsragtriad/
## 9
...
Evaluation  FrameworkEvaluation  TargetsEvaluation  AspectsQuantitative  Metrics
## RGB
## †
## Retrieval Quality
## Generation Quality
...
## RECALL
## †
Generation QualityCounterfactual RobustnessR-Rate (Reappearance Rate)
## RAGAS
## ‡
## Retrieval Quality
## Generation Quality
...
The  possibility  of  an  Inverse  Scaling  Law
## 10
,  where  smaller
...
RAG-centric  services.  Weaviate’s  Verba
## 11
is  designed  for
...
language  models  struggle  to  learn  long-tail  knowledge,”  inInterna-
...
[8]  I.ILIN,“Advancedragtechniques:anil-
lustratedoverview,”https://pub.towardsai.net/
advanced-rag-techniques-an-illustrated-overview-04d193d8fec6,
## 2023.
[9]  W.  Peng,  G.  Li,  Y.  Jiang,  Z.  Wang,  D.  Ou,  X.  Zeng,  E.  Chenet  al.,
...
[16]  A.H.Raudaschl,“Forgetrag,thefuture
israg-fusion,”https://towardsdatascience.com/
...
driguez,  J.  Kahn,  G.  Szilvasy,  M.  Lewiset  al.,  “Ra-dit:  Retrieval-
...
you  need,”  inThe  Eleventh  International  Conference  on  Learning
...
O.  Kuchaiev,  B.  Li,  C.  Xiaoet  al.,  “Shall  we  pretrain  autoregressive
...
ing  reasoning  questions,”  inProceedings  of  the  2023  Conference  on
Empirical Methods in Natural Language Processing, 2023, pp. 1–14.
## [56]  N.  Thakur,  L.  Bonifacio,  X.  Zhang,  O.  Ogundepo,  E.  Kamalloo,
D. Alfonso-Hermelo, X. Li, Q. Liu, B. Chen, M. Rezagholizadehet al.,
...
H.  Ding,  X.  Chu,  J.  Zhaoet  al.,  “Think  and  retrieval:  A  hypothesis
...
X. Li, A. Suet al., “Tablegpt: Towards unifying tables, nature language
...
and  knowledge  graphs,”  inProceedings  of  the  AAAI  Conference  on
...
[88]  R.Teja,“Evaluatingtheidealchunksizeforarag
systemusingllamaindex,”https://www.llamaindex.ai/blog/
...
com/docs/modules/dataconnection/documenttransformers/recursive
textsplitter, 2023.
[90]  S.Yang,“Advancedrag01:Small-to-
bigretrieval,”https://towardsdatascience.com/
...
urmans, C. Cui, O. Bousquet, Q. Leet al., “Least-to-most prompting
...
freebase  from  question-answer  pairs,”  inProceedings  of  the  2013
...
Awadallah,  A.  Celikyilmaz,  Y.  Liu,  X.  Qiuet  al.,  “Qmsum:  A  new
...
question  answering  dataset  for  covid-19,”  inACL  2020  Workshop  on
Natural Language Processing for COVID-19 (NLP-COVID), 2020.
## [128]  X. Wang, G. H. Chen, D. Song, Z. Zhang, Z. Chen, Q. Xiao, F. Jiang,
J.  Li,  X.  Wan,  B.  Wanget  al.,  “Cmb:  A  comprehensive  medical
...
makumar,  J.  Ma,  J.  Thompson,  H.  Heet  al.,  “Quality:  Question  an-
...
of fashion trends with one-class collaborative filtering,” inproceedings
...
with  knowledge  base  triples,”  inProceedings  of  the  Eleventh  Inter-
...
of communal violence and its evaluation,” inProceedings of the First
Workshop on Bangla Language Processing (BLP-2023), 2023, pp. 72–
## 84.
[155]  X. Li and D. Roth, “Learning question classifiers,” inCOLING 2002:
...
over a sentiment treebank,” inProceedings of the 2013 conference on
...
M. Plappert, J. Tworek, J. Hilton, R. Nakanoet al., “Training verifiers
...
[166]  C.JarvisandJ.Allard,“Asurveyoftechniquesfor
maximizingllmperformance,”https://community.openai.
...
language  model  for  dense  video  captioning,”  inProceedings  of  the
IEEE/CVF  Conference  on  Computer  Vision  and  Pattern  Recognition,
2023, pp. 10 714–10 726.
[182]  N.  Nashid,  M.  Sintaha,  and  A.  Mesbah,  “Retrieval-based  prompt
selection for code-related few-shot learning,” in2023 IEEE/ACM 45th
