...
\begin{figure}
        \centering
        \includegraphics[width=0.5\linewidth]{Central_University_of_Jharkhand_logo.png}
...
\textbf{Title of the Project:} MRI Brain Tumor Detection System Using VGG16\\[0.8cm]
