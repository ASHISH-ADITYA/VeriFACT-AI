...
\begin{figure}[H]
\centering
% Accuracy comparison as a simple TikZ bar chart
\begin{tikzpicture}[font=\small]
\draw[thick] (0,0) -- (0,4.5);
\draw[thick] (0,0) -- (8,0);
% Y-axis labels
\foreach \y/\v in {0/0, 1/25, 2/50, 3/75, 4/100} {
    \draw (-0.1,\y) -- (0.1,\y) node[left=0.2cm] {\v\%};
}
% Bars
\fill[green!40] (0.5,0) rectangle (1.5,3.752); \node[font=\scriptsize, above] at (1,3.752) {93.8\%};
\node[font=\scriptsize, below] at (1,-0.2) {HaluEval};
\fill[blue!40] (2,0) rectangle (3,3.28); \node[font=\scriptsize, above] at (2.5,3.28) {82\%};
\node[font=\scriptsize, below] at (2.5,-0.2) {Adversarial};
\fill[green!60] (3.5,0) rectangle (4.5,4); \node[font=\scriptsize, above] at (4,4) {100\%};
\node[font=\scriptsize, below] at (4,-0.2) {Live Mix};
\fill[green!60] (5,0) rectangle (6,4); \node[font=\scriptsize, above] at (5.5,4) {100\%};
\node[font=\scriptsize, below] at (5.5,-0.2) {Rules};
\fill[red!30] (6.5,0) rectangle (7.5,1.764); \node[font=\scriptsize, above] at (7,1.764) {44.1\%};
\node[font=\scriptsize, below] at (7,-0.2) {TruthfulQA};
\end{tikzpicture}
